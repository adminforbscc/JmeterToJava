...
public class TaskAppGetsubtag extends AbstractJavaSamplerClient {
	...
	public SampleResult runTest(JavaSamplerContext arg0) {
        ...
        sr.setSampleLabel( "Taskgetsubtag请求");
        try {
			...
			//修改 http
			result=HttpRequest.sendPost(baseurl+"user/get_sub_tag", encryptdata);
    ...
    { // TODO Auto-generated method stub
    	...
    	Taskgetsubtag test = new Taskgetsubtag(); 
        test.setupTest(arg0); 
        test.runTest(arg0);
